...
CREATE TABLE `meanspayment` (
  `idMeansPaiement` int NOT NULL AUTO_INCREMENT,
  `designation` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`idMeansPaiement`)
...
INSERT INTO `meanspayment` VALUES (1,'CB'),(2,'Paypall'),(3,'Virement bancaire');
...
-- Dump completed on 2021-10-24 12:01:47
